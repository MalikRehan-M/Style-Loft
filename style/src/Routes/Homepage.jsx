...
const Homepage = () => {
  return (
    <div>
      <Carousel />
      <Midsection />
      <Box w="62%" m="auto" p="40px" lineHeight="20px" boxShadow=" rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px">
        <Text fontWeight="600" fontSize="22px" marginLeft={8}>
        ...
        <Accordion defaultIndex={[0]} allowMultiple transitionDelay="3s">
          <AccordionItem>
            <h2>
              <AccordionButton p="8px" backgroundColor="white" border="none" borderBottom="1px solid grey">
                <Flex w="100%">
