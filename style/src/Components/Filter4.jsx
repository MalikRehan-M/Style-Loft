        ...
        <FilterReusable name="FABRIC">
            ...
            <Flex align="center" flexDir="column" w="100%">
                <Flex gap="5px" h="70%" position="absolute" top="85px" overflowY="scroll" w="80%" flexDir="column">
                    ...
                    <Checkbox>Silk</Checkbox>
                    <Checkbox>Pure Cotton</Checkbox>
                    <Checkbox>Art Silk</Checkbox>
                    <Checkbox>Linen</Checkbox>
                    <Checkbox>Georgette</Checkbox>
                    <Checkbox>Silk Blend</Checkbox>
                    <Checkbox>Organze</Checkbox>
                    <Checkbox>Crepe</Checkbox>
                    <Checkbox>Banarasi Silk</Checkbox>
                    <Checkbox>Blended</Checkbox>
                    <Checkbox>Chiffon</Checkbox>
                </Flex>
            </Flex>
        </FilterReusable>
    )
