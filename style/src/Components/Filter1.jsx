        ...
        <FilterReusable name="CATEGORIES">
            ...
            <Flex align="center" flexDir="column" w="100%">
                <Flex gap="5px" h="70%" position="absolute" top="85px" overflowY="scroll" w="80%" flexDir="column">
                    <Checkbox>Cotton Sarees</Checkbox>
                    <Checkbox>Silk Sarees</Checkbox>
                    <Checkbox>Banarasi Sarees</Checkbox>
                    <Checkbox>Bengali Sarees</Checkbox>
                    <Checkbox>South Indian</Checkbox>
                    <Checkbox>Georgette Sarees</Checkbox>
                    <Checkbox>Cotton Silk</Checkbox>
                    <Checkbox>Sarees</Checkbox>
                    <Checkbox>Net Sarees</Checkbox>
                    <Checkbox>Mysore Silk Sarees</Checkbox>
                    <Checkbox>Bridal Sarees</Checkbox>
                </Flex>
            </Flex>
        </FilterReusable>
    )
